  ...
  return (
    <>
      <nav className="flex justify-center items-center py-4 px-8 bg-[#13111c] w-full max-[800px]:px-1 max-[800px]:py-1ax-[800px]:px-1 max-[800px]:py-1">
        <div className="px-[60px] pb-3 flex items-center space-x-4 rounded-b-[90px] border-b-8 border-x-8 border-[#2a2832] max-[800px]:border-b-[4px] max-[800px]:border-x-[4px] max-[800px]:px-[39px] max-[800px]:py-1 max-[800px]:rounded-b-[50px]">
          <img
            src={image}
